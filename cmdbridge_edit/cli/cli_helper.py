...
class CmdBridgeEditCLIHelper:
    """cmdbridge-edit command line helper class - handles CLI business logic"""
    ...
    def exit_with_success_code(self, success: bool) -> None:
        """Exit program based on operation result
        
        Args:
            success: Whether the operation was successful
        """
        # Use special exit code 113 to indicate successful mapping (for shell function recognition)
